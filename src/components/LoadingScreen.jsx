    ...
    >
      ...
      <div className="flex items-end justify-between w-full">
        <div className="hidden sm:block">
          <p className="text-xs text-[#a3a3a3] uppercase tracking-[0.2em] font-semibold">EST. 1994</p>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-white/10 overflow-hidden">
        <div
          className="h-full bg-gradient-to-r from-[#991b1b] to-[#dc2626] transition-all duration-75 ease-out origin-left"
          style={{
